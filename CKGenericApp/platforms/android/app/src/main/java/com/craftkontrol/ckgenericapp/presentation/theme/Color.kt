package com.craftkontrol.ckgenericapp.presentation.theme

import androidx.compose.ui.graphics.Color

// Light Theme Colors
val md_theme_light_primary = Color(0xFF4A9EFF)
val md_theme_light_onPrimary = Color(0xFFFFFFFF)
val md_theme_light_primaryContainer = Color(0xFFD8E4FF)
...
// Dark Theme Colors (CraftKontrol Style)
val md_theme_dark_primary = Color(0xFF4A9EFF)
val md_theme_dark_onPrimary = Color(0xFF003062)
val md_theme_dark_primaryContainer = Color(0xFF0046A3)
val md_theme_dark_onPrimaryContainer = Color(0xFFD8E4FF)
...
val md_theme_dark_tertiary = Color(0xFFE1BADD)
...
val md_theme_dark_error = Color(0xFFFF4444)
