...
const translations = {
    fr: {
        ...
        'apiKey.googledrive_client_id': 'Google Drive Client ID (OAuth2)',
        'apiKey.onedrive_client_id': 'OneDrive Client ID (OAuth2)',
        'apiKey.dropbox_client_id': 'Dropbox Client ID (App Key)',
        'apiKey.icloud_container_id': 'iCloud Container ID',
        'apiKey.icloud_api_token': 'iCloud API Token',
